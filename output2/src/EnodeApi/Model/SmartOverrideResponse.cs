...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SmartOverrideResponse")]
    public partial class SmartOverrideResponse : IEquatable<SmartOverrideResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SmartOverrideResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SmartOverrideResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SmartOverrideResponse" /> class.
        /// </summary>
        ...
        public SmartOverrideResponse(string userId = default(string), DateTime createdAt = default(DateTime), DateTime? endedAt = default(DateTime?), ChargeableVendorType targetType = default(ChargeableVendorType), ChargeableVendor vendor = default(ChargeableVendor), string targetId = default(string), string vendorActionId = default(string))
        {
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new ArgumentNullException("userId is a required property for SmartOverrideResponse and cannot be null");
            }
            this.UserId = userId;
            ...
            if (endedAt == null)
            {
                throw new ArgumentNullException("endedAt is a required property for SmartOverrideResponse and cannot be null");
            }
            ...
            if (vendor == null)
            {
                throw new ArgumentNullException("vendor is a required property for SmartOverrideResponse and cannot be null");
            }
            this.Vendor = vendor;
            // to ensure "targetId" is required (not null)
            if (targetId == null)
            {
                throw new ArgumentNullException("targetId is a required property for SmartOverrideResponse and cannot be null");
            }
            this.TargetId = targetId;
            // to ensure "vendorActionId" is required (not null)
            if (vendorActionId == null)
            {
                throw new ArgumentNullException("vendorActionId is a required property for SmartOverrideResponse and cannot be null");
            }
        ...
        public ChargeableVendor Vendor { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SmartOverrideResponse {\n");
        ...
        {
            return this.Equals(input as SmartOverrideResponse);
        }

        /// <summary>
        /// Returns true if SmartOverrideResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SmartOverrideResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmartOverrideResponse input)
        {
            if (input == null)
            {
                return false;
