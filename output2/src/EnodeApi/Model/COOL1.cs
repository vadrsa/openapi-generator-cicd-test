...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "COOL_1")]
    public partial class COOL1 : IEquatable<COOL1>, IValidatableObject
    {
        /// <summary>
        /// Defines HoldType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="COOL1" /> class.
        /// </summary>
        ...
        public COOL1(HoldTypeEnum? holdType = default(HoldTypeEnum?), ModeEnum mode = default(ModeEnum), decimal coolSetpoint = default(decimal))
        {
            this.Mode = mode;
        ...
        {
            return this.Equals(input as COOL1);
        }

        /// <summary>
        /// Returns true if COOL1 instances are equal
        /// </summary>
        /// <param name="input">Instance of COOL1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(COOL1 input)
        {
            if (input == null)
            {
                return false;
