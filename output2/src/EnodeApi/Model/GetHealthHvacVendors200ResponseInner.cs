...
{
    /// <summary>
    /// GetHealthHvacVendors200ResponseInner
    /// </summary>
    [DataContract(Name = "getHealthHvacVendors_200_response_inner")]
    public partial class GetHealthHvacVendors200ResponseInner : IEquatable<GetHealthHvacVendors200ResponseInner>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHealthHvacVendors200ResponseInner" /> class.
        /// </summary>
        ...
        public GetHealthHvacVendors200ResponseInner(HVACVendor? vendor = default(HVACVendor?), string displayName = default(string), string portalName = default(string), StatusEnum? status = default(StatusEnum?))
        {
            this.Vendor = vendor;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetHealthHvacVendors200ResponseInner {\n");
        ...
        {
            return this.Equals(input as GetHealthHvacVendors200ResponseInner);
        }

        /// <summary>
        /// Returns true if GetHealthHvacVendors200ResponseInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetHealthHvacVendors200ResponseInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetHealthHvacVendors200ResponseInner input)
        {
            if (input == null)
            {
                return false;
