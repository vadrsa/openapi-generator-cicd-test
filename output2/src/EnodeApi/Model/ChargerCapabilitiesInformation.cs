...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargerCapabilities_information")]
    public partial class ChargerCapabilitiesInformation : IEquatable<ChargerCapabilitiesInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargerCapabilitiesInformation" /> class.
        /// </summary>
        ...
        public ChargerCapabilitiesInformation(bool isCapable = default(bool), List<string> interventionIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChargerCapabilitiesInformation {\n");
        ...
        {
            return this.Equals(input as ChargerCapabilitiesInformation);
        }

        /// <summary>
        /// Returns true if ChargerCapabilitiesInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargerCapabilitiesInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargerCapabilitiesInformation input)
        {
            if (input == null)
            {
                return false;
