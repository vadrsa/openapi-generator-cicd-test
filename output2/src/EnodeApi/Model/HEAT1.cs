...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HEAT_1")]
    public partial class HEAT1 : IEquatable<HEAT1>, IValidatableObject
    {
        /// <summary>
        /// Defines HoldType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HEAT1" /> class.
        /// </summary>
        ...
        public HEAT1(HoldTypeEnum? holdType = default(HoldTypeEnum?), ModeEnum mode = default(ModeEnum), decimal heatSetpoint = default(decimal))
        {
            this.Mode = mode;
        ...
        {
            return this.Equals(input as HEAT1);
        }

        /// <summary>
        /// Returns true if HEAT1 instances are equal
        /// </summary>
        /// <param name="input">Instance of HEAT1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HEAT1 input)
        {
            if (input == null)
            {
                return false;
