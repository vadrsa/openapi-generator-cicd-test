...
{
    /// <summary>
    /// VehicleSmartChargingStatusPlan
    /// </summary>
    [DataContract(Name = "VehicleSmartChargingStatus_plan")]
    public partial class VehicleSmartChargingStatusPlan : IEquatable<VehicleSmartChargingStatusPlan>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleSmartChargingStatusPlan" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VehicleSmartChargingStatusPlan() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleSmartChargingStatusPlan" /> class.
        /// </summary>
        ...
        public VehicleSmartChargingStatusPlan(string id = default(string), string chargingLocationId = default(string), string vehicleId = default(string), string userId = default(string), string vendor = default(string), string currency = default(string), decimal nonSmartCost = default(decimal), decimal? smartCost = default(decimal?), DateTime stopAt = default(DateTime), DateTime? startAt = default(DateTime?), DateTime estimatedFinishAt = default(DateTime), DateTime? stopConfirmedAt = default(DateTime?), DateTime? startConfirmedAt = default(DateTime?), DateTime? endedAt = default(DateTime?), FinalStateEnum finalState = default(FinalStateEnum), FailureConditionEnum failureCondition = default(FailureConditionEnum), DEPRECATEDExternalStart externalStart = default(DEPRECATEDExternalStart))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
            this.Id = id;
            // to ensure "chargingLocationId" is required (not null)
            if (chargingLocationId == null)
            {
                throw new ArgumentNullException("chargingLocationId is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
            this.ChargingLocationId = chargingLocationId;
            // to ensure "vehicleId" is required (not null)
            if (vehicleId == null)
            {
                throw new ArgumentNullException("vehicleId is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
            this.VehicleId = vehicleId;
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new ArgumentNullException("userId is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
            this.UserId = userId;
            // to ensure "vendor" is required (not null)
            if (vendor == null)
            {
                throw new ArgumentNullException("vendor is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
            this.Vendor = vendor;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
            ...
            if (smartCost == null)
            {
                throw new ArgumentNullException("smartCost is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
            ...
            if (startAt == null)
            {
                throw new ArgumentNullException("startAt is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("stopConfirmedAt is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
            this.StopConfirmedAt = stopConfirmedAt;
            // to ensure "startConfirmedAt" is required (not null)
            if (startConfirmedAt == null)
            {
                throw new ArgumentNullException("startConfirmedAt is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
            this.StartConfirmedAt = startConfirmedAt;
            // to ensure "endedAt" is required (not null)
            if (endedAt == null)
            {
                throw new ArgumentNullException("endedAt is a required property for VehicleSmartChargingStatusPlan and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VehicleSmartChargingStatusPlan {\n");
        ...
        {
            return this.Equals(input as VehicleSmartChargingStatusPlan);
        }

        /// <summary>
        /// Returns true if VehicleSmartChargingStatusPlan instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleSmartChargingStatusPlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleSmartChargingStatusPlan input)
        {
            if (input == null)
            {
                return false;
