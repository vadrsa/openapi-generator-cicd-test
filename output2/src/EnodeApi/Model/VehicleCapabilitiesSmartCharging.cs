...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VehicleCapabilities_smartCharging")]
    public partial class VehicleCapabilitiesSmartCharging : IEquatable<VehicleCapabilitiesSmartCharging>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleCapabilitiesSmartCharging" /> class.
        /// </summary>
        ...
        public VehicleCapabilitiesSmartCharging(bool isCapable = default(bool), List<string> interventionIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VehicleCapabilitiesSmartCharging {\n");
        ...
        {
            return this.Equals(input as VehicleCapabilitiesSmartCharging);
        }

        /// <summary>
        /// Returns true if VehicleCapabilitiesSmartCharging instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleCapabilitiesSmartCharging to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleCapabilitiesSmartCharging input)
        {
            if (input == null)
            {
                return false;
