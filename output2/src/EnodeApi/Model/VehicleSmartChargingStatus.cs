...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VehicleSmartChargingStatus")]
    public partial class VehicleSmartChargingStatus : IEquatable<VehicleSmartChargingStatus>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleSmartChargingStatus" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VehicleSmartChargingStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleSmartChargingStatus" /> class.
        /// </summary>
        ...
        public VehicleSmartChargingStatus(DateTime updatedAt = default(DateTime), string vehicleId = default(string), string userId = default(string), string vendor = default(string), StateEnum state = default(StateEnum), DateTime stateChangedAt = default(DateTime), VehicleSmartChargingStatusConsideration consideration = default(VehicleSmartChargingStatusConsideration), VehicleSmartChargingStatusPlan plan = default(VehicleSmartChargingStatusPlan), SmartOverrideStatus smartOverride = default(SmartOverrideStatus))
        {
            ...
            {
                throw new ArgumentNullException("consideration is a required property for VehicleSmartChargingStatus and cannot be null");
            }
            this.Consideration = consideration;
            // to ensure "plan" is required (not null)
            if (plan == null)
            {
                throw new ArgumentNullException("plan is a required property for VehicleSmartChargingStatus and cannot be null");
            }
            this.Plan = plan;
            // to ensure "smartOverride" is required (not null)
            if (smartOverride == null)
            {
                throw new ArgumentNullException("smartOverride is a required property for VehicleSmartChargingStatus and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VehicleSmartChargingStatus {\n");
        ...
        {
            return this.Equals(input as VehicleSmartChargingStatus);
        }

        /// <summary>
        /// Returns true if VehicleSmartChargingStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleSmartChargingStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleSmartChargingStatus input)
        {
            if (input == null)
            {
                return false;
