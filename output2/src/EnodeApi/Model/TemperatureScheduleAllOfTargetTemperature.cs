...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Temperature_Schedule_allOf_targetTemperature")]
    public partial class TemperatureScheduleAllOfTargetTemperature : IEquatable<TemperatureScheduleAllOfTargetTemperature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemperatureScheduleAllOfTargetTemperature" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TemperatureScheduleAllOfTargetTemperature() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemperatureScheduleAllOfTargetTemperature" /> class.
        /// </summary>
        ...
        public TemperatureScheduleAllOfTargetTemperature(decimal? temperature = default(decimal?), decimal? deadband = default(decimal?))
        {
            // to ensure "temperature" is required (not null)
            if (temperature == null)
            {
                throw new ArgumentNullException("temperature is a required property for TemperatureScheduleAllOfTargetTemperature and cannot be null");
            }
            this.Temperature = temperature;
            // to ensure "deadband" is required (not null)
            if (deadband == null)
            {
                throw new ArgumentNullException("deadband is a required property for TemperatureScheduleAllOfTargetTemperature and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemperatureScheduleAllOfTargetTemperature {\n");
        ...
        {
            return this.Equals(input as TemperatureScheduleAllOfTargetTemperature);
        }

        /// <summary>
        /// Returns true if TemperatureScheduleAllOfTargetTemperature instances are equal
        /// </summary>
        /// <param name="input">Instance of TemperatureScheduleAllOfTargetTemperature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemperatureScheduleAllOfTargetTemperature input)
        {
            if (input == null)
            {
                return false;
