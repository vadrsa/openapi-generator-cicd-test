...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargerCapabilities_startCharging")]
    public partial class ChargerCapabilitiesStartCharging : IEquatable<ChargerCapabilitiesStartCharging>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargerCapabilitiesStartCharging" /> class.
        /// </summary>
        ...
        public ChargerCapabilitiesStartCharging(bool isCapable = default(bool), List<string> interventionIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChargerCapabilitiesStartCharging {\n");
        ...
        {
            return this.Equals(input as ChargerCapabilitiesStartCharging);
        }

        /// <summary>
        /// Returns true if ChargerCapabilitiesStartCharging instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargerCapabilitiesStartCharging to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargerCapabilitiesStartCharging input)
        {
            if (input == null)
            {
                return false;
