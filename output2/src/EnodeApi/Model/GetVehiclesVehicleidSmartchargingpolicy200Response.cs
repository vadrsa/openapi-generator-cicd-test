...
{
    /// <summary>
    /// GetVehiclesVehicleidSmartchargingpolicy200Response
    /// </summary>
    [DataContract(Name = "getVehiclesVehicleidSmartchargingpolicy_200_response")]
    public partial class GetVehiclesVehicleidSmartchargingpolicy200Response : IEquatable<GetVehiclesVehicleidSmartchargingpolicy200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetVehiclesVehicleidSmartchargingpolicy200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetVehiclesVehicleidSmartchargingpolicy200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetVehiclesVehicleidSmartchargingpolicy200Response" /> class.
        /// </summary>
        /// <param name="isEnabled">When enabled, this vehicle&#39;s charging status may be controlled by [Smart Charging](/docs/smart-charging/introduction) (required).</param>
        /// <param name="deadline">The hour-minute deadline for fully charging the vehicle. Smart charging does not work without setting a deadline. If a timezone is set on the charging location at which the smart charging ocurrs, the deadline is interpreted in that timezone, otherwise UTC is used. (required).</param>
        /// <param name="minimumChargeLimit">Immediately charge without regard for energy prices until the vehicle reaches this minimum limit. The &#x60;hasChargeAboveThreshold&#x60; Smart Charge consideration uses this value. Defaults to zero. (required).</param>
        public GetVehiclesVehicleidSmartchargingpolicy200Response(bool? isEnabled = default(bool?), string deadline = default(string), decimal minimumChargeLimit = default(decimal))
        {
            // to ensure "isEnabled" is required (not null)
            if (isEnabled == null)
            {
                throw new ArgumentNullException("isEnabled is a required property for GetVehiclesVehicleidSmartchargingpolicy200Response and cannot be null");
            }
            this.IsEnabled = isEnabled;
            // to ensure "deadline" is required (not null)
            if (deadline == null)
            {
                throw new ArgumentNullException("deadline is a required property for GetVehiclesVehicleidSmartchargingpolicy200Response and cannot be null");
            }
        ...
        [DataMember(Name = "minimumChargeLimit", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetVehiclesVehicleidSmartchargingpolicy200Response {\n");
        ...
        {
            return this.Equals(input as GetVehiclesVehicleidSmartchargingpolicy200Response);
        }

        /// <summary>
        /// Returns true if GetVehiclesVehicleidSmartchargingpolicy200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetVehiclesVehicleidSmartchargingpolicy200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetVehiclesVehicleidSmartchargingpolicy200Response input)
        {
            if (input == null)
            {
                return false;
