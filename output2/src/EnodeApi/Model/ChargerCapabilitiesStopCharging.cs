...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargerCapabilities_stopCharging")]
    public partial class ChargerCapabilitiesStopCharging : IEquatable<ChargerCapabilitiesStopCharging>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargerCapabilitiesStopCharging" /> class.
        /// </summary>
        ...
        public ChargerCapabilitiesStopCharging(bool isCapable = default(bool), List<string> interventionIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChargerCapabilitiesStopCharging {\n");
        ...
        {
            return this.Equals(input as ChargerCapabilitiesStopCharging);
        }

        /// <summary>
        /// Returns true if ChargerCapabilitiesStopCharging instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargerCapabilitiesStopCharging to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargerCapabilitiesStopCharging input)
        {
            if (input == null)
            {
                return false;
