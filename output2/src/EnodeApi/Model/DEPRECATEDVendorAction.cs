...
{
    /// <summary>
    /// DEPRECATEDVendorAction
    /// </summary>
    [DataContract(Name = "DEPRECATED_VendorAction")]
    public partial class DEPRECATEDVendorAction : IEquatable<DEPRECATEDVendorAction>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DEPRECATEDVendorAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DEPRECATEDVendorAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DEPRECATEDVendorAction" /> class.
        /// </summary>
        ...
        public DEPRECATEDVendorAction(string id = default(string), string targetId = default(string), VendorType? targetType = default(VendorType?), ChargingAction? kind = default(ChargingAction?), VendorActionTarget target = default(VendorActionTarget), VendorActionTargetState targetState = default(VendorActionTargetState), string createdAt = default(string), string updatedAt = default(string), string completedAt = default(string), VendorActionState state = default(VendorActionState), string entityId = default(string), EntityTypeEnum? entityType = default(EntityTypeEnum?), string chargeableId = default(string), ChargeableTypeEnum? chargeableType = default(ChargeableTypeEnum?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for DEPRECATEDVendorAction and cannot be null");
            }
            this.Id = id;
            // to ensure "createdAt" is required (not null)
            if (createdAt == null)
            {
                throw new ArgumentNullException("createdAt is a required property for DEPRECATEDVendorAction and cannot be null");
            }
            this.CreatedAt = createdAt;
            // to ensure "updatedAt" is required (not null)
            if (updatedAt == null)
            {
                throw new ArgumentNullException("updatedAt is a required property for DEPRECATEDVendorAction and cannot be null");
            }
            this.UpdatedAt = updatedAt;
            // to ensure "completedAt" is required (not null)
            if (completedAt == null)
            {
                throw new ArgumentNullException("completedAt is a required property for DEPRECATEDVendorAction and cannot be null");
            }
            this.CompletedAt = completedAt;
            // to ensure "state" is required (not null)
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for DEPRECATEDVendorAction and cannot be null");
            }
            this.State = state;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DEPRECATEDVendorAction {\n");
        ...
        {
            return this.Equals(input as DEPRECATEDVendorAction);
        }

        /// <summary>
        /// Returns true if DEPRECATEDVendorAction instances are equal
        /// </summary>
        /// <param name="input">Instance of DEPRECATEDVendorAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DEPRECATEDVendorAction input)
        {
            if (input == null)
            {
                return false;
