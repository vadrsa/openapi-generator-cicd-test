...
{
    /// <summary>
    /// Support for STOP charging command
    /// </summary>
    [DataContract(Name = "VehicleCapabilities_stopCharging")]
    public partial class VehicleCapabilitiesStopCharging : IEquatable<VehicleCapabilitiesStopCharging>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleCapabilitiesStopCharging" /> class.
        /// </summary>
        ...
        public VehicleCapabilitiesStopCharging(bool isCapable = default(bool), List<string> interventionIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VehicleCapabilitiesStopCharging {\n");
        ...
        {
            return this.Equals(input as VehicleCapabilitiesStopCharging);
        }

        /// <summary>
        /// Returns true if VehicleCapabilitiesStopCharging instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleCapabilitiesStopCharging to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleCapabilitiesStopCharging input)
        {
            if (input == null)
            {
                return false;
