...
namespace EnodeApi.Model
{
    ...
    /// ScheduleFilters
    /// </summary>
    [DataContract(Name = "ScheduleFilters")]
    public partial class ScheduleFilters : IEquatable<ScheduleFilters>, IValidatableObject
    {
        /// <summary>
        /// Defines Weekdays
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleFilters" /> class.
        /// </summary>
        ...
        public ScheduleFilters(ScheduleFiltersHourMinute hourMinute = default(ScheduleFiltersHourMinute), DateTime fromTimestamp = default(DateTime), DateTime toTimestamp = default(DateTime), List<WeekdaysEnum> weekdays = default(List<WeekdaysEnum>))
        {
        ...
        public List<ScheduleFilters.WeekdaysEnum> Weekdays { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScheduleFilters {\n");
        ...
        {
            return this.Equals(input as ScheduleFilters);
        }

        /// <summary>
        /// Returns true if ScheduleFilters instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduleFilters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleFilters input)
        {
            if (input == null)
            {
                return false;
