...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargerCapabilities_chargeState")]
    public partial class ChargerCapabilitiesChargeState : IEquatable<ChargerCapabilitiesChargeState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargerCapabilitiesChargeState" /> class.
        /// </summary>
        ...
        public ChargerCapabilitiesChargeState(bool isCapable = default(bool), List<string> interventionIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChargerCapabilitiesChargeState {\n");
        ...
        {
            return this.Equals(input as ChargerCapabilitiesChargeState);
        }

        /// <summary>
        /// Returns true if ChargerCapabilitiesChargeState instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargerCapabilitiesChargeState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargerCapabilitiesChargeState input)
        {
            if (input == null)
            {
                return false;
