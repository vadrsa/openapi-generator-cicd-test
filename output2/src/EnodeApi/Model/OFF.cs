...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OFF")]
    public partial class OFF : IEquatable<OFF>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OFF" /> class.
        /// </summary>
        ...
        public OFF(ModeEnum mode = default(ModeEnum))
        {
            this.Mode = mode;
        }
        ...
        {
            return this.Equals(input as OFF);
        }

        /// <summary>
        /// Returns true if OFF instances are equal
        /// </summary>
        /// <param name="input">Instance of OFF to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OFF input)
        {
            if (input == null)
            {
                return false;
