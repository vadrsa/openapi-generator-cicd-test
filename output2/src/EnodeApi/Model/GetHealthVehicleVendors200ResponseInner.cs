...
{
    /// <summary>
    /// GetHealthVehicleVendors200ResponseInner
    /// </summary>
    [DataContract(Name = "getHealthVehicleVendors_200_response_inner")]
    public partial class GetHealthVehicleVendors200ResponseInner : IEquatable<GetHealthVehicleVendors200ResponseInner>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHealthVehicleVendors200ResponseInner" /> class.
        /// </summary>
        ...
        public GetHealthVehicleVendors200ResponseInner(VehicleVendor? vendor = default(VehicleVendor?), string displayName = default(string), string portalName = default(string), StatusEnum? status = default(StatusEnum?))
        {
            this.Vendor = vendor;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetHealthVehicleVendors200ResponseInner {\n");
        ...
        {
            return this.Equals(input as GetHealthVehicleVendors200ResponseInner);
        }

        /// <summary>
        /// Returns true if GetHealthVehicleVendors200ResponseInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetHealthVehicleVendors200ResponseInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetHealthVehicleVendors200ResponseInner input)
        {
            if (input == null)
            {
                return false;
