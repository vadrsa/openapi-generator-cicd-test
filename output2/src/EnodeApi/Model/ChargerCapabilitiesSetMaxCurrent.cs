...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargerCapabilities_setMaxCurrent")]
    public partial class ChargerCapabilitiesSetMaxCurrent : IEquatable<ChargerCapabilitiesSetMaxCurrent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargerCapabilitiesSetMaxCurrent" /> class.
        /// </summary>
        ...
        public ChargerCapabilitiesSetMaxCurrent(bool isCapable = default(bool), List<string> interventionIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChargerCapabilitiesSetMaxCurrent {\n");
        ...
        {
            return this.Equals(input as ChargerCapabilitiesSetMaxCurrent);
        }

        /// <summary>
        /// Returns true if ChargerCapabilitiesSetMaxCurrent instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargerCapabilitiesSetMaxCurrent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargerCapabilitiesSetMaxCurrent input)
        {
            if (input == null)
            {
                return false;
