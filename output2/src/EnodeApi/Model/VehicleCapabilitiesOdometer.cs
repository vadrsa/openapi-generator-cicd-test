...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VehicleCapabilities_odometer")]
    public partial class VehicleCapabilitiesOdometer : IEquatable<VehicleCapabilitiesOdometer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleCapabilitiesOdometer" /> class.
        /// </summary>
        ...
        public VehicleCapabilitiesOdometer(bool isCapable = default(bool), List<string> interventionIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VehicleCapabilitiesOdometer {\n");
        ...
        {
            return this.Equals(input as VehicleCapabilitiesOdometer);
        }

        /// <summary>
        /// Returns true if VehicleCapabilitiesOdometer instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleCapabilitiesOdometer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleCapabilitiesOdometer input)
        {
            if (input == null)
            {
                return false;
