...
namespace EnodeApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SmartOverrideStatus")]
    public partial class SmartOverrideStatus : IEquatable<SmartOverrideStatus>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SmartOverrideStatus" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SmartOverrideStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SmartOverrideStatus" /> class.
        /// </summary>
        ...
        public SmartOverrideStatus(DateTime createdAt = default(DateTime), DateTime? endedAt = default(DateTime?), ChargeableVendorType targetType = default(ChargeableVendorType), string targetId = default(string), string vendorActionId = default(string))
        {
            this.CreatedAt = createdAt;
            // to ensure "endedAt" is required (not null)
            if (endedAt == null)
            {
                throw new ArgumentNullException("endedAt is a required property for SmartOverrideStatus and cannot be null");
            }
            ...
            if (targetId == null)
            {
                throw new ArgumentNullException("targetId is a required property for SmartOverrideStatus and cannot be null");
            }
            this.TargetId = targetId;
            // to ensure "vendorActionId" is required (not null)
            if (vendorActionId == null)
            {
                throw new ArgumentNullException("vendorActionId is a required property for SmartOverrideStatus and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SmartOverrideStatus {\n");
        ...
        {
            return this.Equals(input as SmartOverrideStatus);
        }

        /// <summary>
        /// Returns true if SmartOverrideStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of SmartOverrideStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmartOverrideStatus input)
        {
            if (input == null)
            {
                return false;
